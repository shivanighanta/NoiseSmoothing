...
//		frame.setVisible(true);
		...
		double[] test = {1,2,1,2,1,2,1,2,1,2};
		System.out.println(Arrays.toString(generalRunningAverage(test, 5)));
	}
	 ...
	 */
	public static double[] runningAverage(double[] array) {
		double[] average = new double[array.length-1];
		for(int i = 0; i < array.length-1; i++) {
			average[i] = (array[i]+array[i+1])/2;
		}
		return average;
	}
	 ...
	 */
	public static double[] runningAverageOfThree(double[] array) {
		double[] average = new double[array.length-2];
		for(int i = 0; i < array.length-2; i++) {
			average[i] = (array[i]+array[i+1]+array[i+2])/3;
		}
		return average;
	}
