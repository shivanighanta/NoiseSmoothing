	...
	public class TrialBasicPlotting extends StepCounter {
		...
		public static void main(String[] args) {
			...
			System.out.println(stepCounterRevised(raw.getCol(1), raw.getRows(1, raw.getNumRows() - 1), 10));
			System.out.println(stepCounter(raw.getCol(1), raw.getRows(1, raw.getNumRows() - 1)));
